sector_designations = {'PSCI':'Index', 'PSCT':'Index', 'PSCM':'Index', 'PSCU':'Index',
...
companies = ['PSCI', 'PSCT', 'PSCM', 'PSCU', 'RSPG', 'RSPF', 'MITK',
            'NXT', 'PATK', 'PECO', 'PUBM', 'STEP', 'ENSG', 'MODG', 
            'WINA', 'AGCO', 'BMI', 'SKY', 'CVLT', 'EHC',  'INMD', 
            'PSR',  'KBWR', 'PSCC', 'PSCH']